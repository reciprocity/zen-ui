...
export const StoryWithAllFormComponents = () => {
  return html/*html*/ `
    <div>
      <zen-form-group>
        <zen-text variant="label" required>Name</zen-text>
        <zen-input></zen-input>
      </zen-form-group>
      <zen-form-group>
        <zen-text variant="label" required>Lastname</zen-text>
        <zen-input></zen-input>
      </zen-form-group>
      <zen-form-group>
        <zen-text variant="label" required>Country</zen-text>
        <zen-dropdown>
          <zen-option>Argentina</zen-option>
          <zen-option>Slovenia</zen-option>
          <zen-option>United States</zen-option>
        </zen-dropdown>
      </zen-form-group>
      <zen-form-group>
        <zen-text variant="label" required>Comments</zen-text>
        <zen-textarea placeholder="Write here..."></zen-textarea>
        <zen-input-support-text text="0 of 2500 characters"></zen-input-support-text>
      </zen-form-group>
      <zen-form-group>
        <zen-checkbox label="Has admin rights"></zen-checkbox>
      </zen-form-group>
      <zen-form-group>
...
### 3. Joining different form groups

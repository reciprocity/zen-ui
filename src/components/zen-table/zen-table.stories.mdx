...
export const StoryTreeWithHeader = () => {
  ...
  return html/*html*/ `
    <sb-zen-table columns="auto 1fr 1fr">
      <sb-zen-table-row @zenSelect="${onRowSelect}" header sticky selectable>
      ...
      <sb-zen-table-row @zenSelect="${onRowSelect}" selectable>
      ...
      <sb-zen-table-row @zenSelect="${onRowSelect}" depth="1" selectable>
      ...
      <sb-zen-table-row @zenSelect="${onRowSelect}" depth="2" selectable>
...
On this story you can also see which when `zenSelect` event gets triggered and for which rows.

...
export const StoryTreeWithHeader = () => {
  ...
  const onSelect = event => {
    console.log('zenSelect, target:', event.target);
  };
  const onToggle = event => {
    console.log('zenToggle, target:', event.target);
  };
  return html/*html*/ `
    <sb-zen-table columns="auto 1fr 1fr">
      <sb-zen-table-row @zenSelect="${onSelect}" @zenToggle="${onToggle}" header sticky selectable>
      ...
      <sb-zen-table-row @zenSelect="${onSelect}" @zenToggle="${onToggle}" selectable>
      ...
      <sb-zen-table-row @zenSelect="${onSelect}" @zenToggle="${onToggle}" depth="1" selectable>
      ...
      <sb-zen-table-row @zenSelect="${onSelect}" @zenToggle="${onToggle}" depth="2" selectable>
...
On this story you can also see which when `zenSelect` and `zenExpand` events gets triggered and for which rows.

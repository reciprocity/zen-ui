...
export const StoryWithControls = args => {
  ...
  const waitAndAddIcon = (id, icon) => waitForElement(`#icon-${id}`, element => {
    element.icon = icon;
  });
    ...
    >
      <sb-zen-sidebar-nav padding="sm" id="sidebar1" ...="${spreadArgs(args, argTypes)}">
        ...
        <sb-zen-sidebar-nav-item @click="${itemClicked}">
          ...
          Program records
          <div slot="subitems">
            <sb-zen-sidebar-nav-subitem @click="${subitemClicked}">Controls</sb-zen-sidebar-nav-subitem>
            <sb-zen-sidebar-nav-subitem @click="${subitemClicked}">Requirements</sb-zen-sidebar-nav-subitem>
            ...
            <sb-zen-sidebar-nav-subitem @click="${subitemClicked}">Tasks</sb-zen-sidebar-nav-subitem>
          </div>
        </sb-zen-sidebar-nav-item>
        <sb-zen-sidebar-nav-item @click="${itemClicked}">

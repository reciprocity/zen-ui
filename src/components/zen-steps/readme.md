...
| `clickable`   | `clickable`    | User can click step to go to step | `StepsFilter.All \| StepsFilter.Completed \| StepsFilter.Incompleted \| StepsFilter.None` | `StepsFilter.Completed` |

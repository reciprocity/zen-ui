...
export const StoryVariants = () => {
  waitForElement('#avatar-detailed', element => {
    ...
    element.email = 'mike.anderson@reciprocitylabs.com';
  ...
  return html/*html*/ `
    <sb-zen-space spacing="sm" vertical-align="center" horizontal-align="space-evenly">
      <sb-zen-space vertical spacing="md" horizontal-align="center">
      ...
      <sb-zen-space vertical spacing="md" horizontal-align="center">
        <sb-zen-avatar-details
          ...
          style="border: 1px solid lightgray"
        ></sb-zen-avatar-details>
        <sb-zen-text size="sm">Variant 'Basic' medium</sb-zen-text>
      </sb-zen-space>
      <sb-zen-space vertical spacing="md" horizontal-align="center">
        <sb-zen-avatar-details
          ...
          style="border: 1px solid lightgray"
        ></sb-zen-avatar-details>
        <sb-zen-text size="sm">Variant 'Basic' small</sb-zen-text>
      </sb-zen-space>
    </sb-zen-space>
  `;
};
...
### 1. Avatar details variants

Different variants of `AvatarDetail` component are `Detailed` and `Basic`. `Detailed` is the default variant. `Basic` variant has additional option to set size.

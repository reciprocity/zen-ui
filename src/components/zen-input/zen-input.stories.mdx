...
import { faUser, faKey } from '@fortawesome/pro-light-svg-icons';
...
export const StoryWithLeadingSlot = () =>
  html/*html*/ `
    <zen-input>
      <i
        slot="leadingSlot"
        style="width: 1rem; margin-top: 0.375rem; margin-left: 0.5rem;"
...
export const StoryWithTrailingSlot = () =>
  html/*html*/ `
    <zen-input>
      <i
        slot="trailingSlot"
        style="width: 1rem; margin-top: 0.375rem; margin-right: 0.5rem;"

...
export const StoryWithControls = args => html/*html*/ `
  <sb-zen-input id="input1" style="max-width: 300px" ...="${spreadArgs(args, argTypes)}"></sb-zen-input>
...
export const StoryWithLeadingSlot = () => {
  ...
  return html/*html*/ `
    <sb-zen-input style="max-width: 300px">
...
export const StoryWithTrailingSlot = () => {
  ...
  return html/*html*/ `
    <sb-zen-input style="max-width: 300px; cursor:pointer" placeholder="Search...">
      <sb-zen-icon
        id="search-icon"
        slot="trailingSlot"

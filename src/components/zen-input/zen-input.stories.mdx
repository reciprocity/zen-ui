...
export const StoryWithControls = args => html/*html*/ `
  <sb-zen-input id="input1" style="min-width: 20rem" ...="${spreadArgs(args, argTypes)}"></sb-zen-input>
...
export const StoryWithLeadingSlot = () => {
  ...
  return html/*html*/ `
    <sb-zen-input style="min-width: 20rem">
...
export const StoryWithTrailingSlot = () => {
  ...
  return html/*html*/ `
    <sb-zen-input style="min-width: 20rem; cursor:pointer" placeholder="Search...">
      <sb-zen-icon
        id="search-icon"
        slot="trailingSlot"
...
export const StoryFormGroup = args =>
  html/*html*/ `
    <sb-zen-space vertical spacing="md" horizontal-align="stretch" style="min-width: 20rem">

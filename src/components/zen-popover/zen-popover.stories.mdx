...
import {faTimes, faTrashAlt, faPlus, faFilter } from '@fortawesome/pro-light-svg-icons';
  ...
  return html/*html*/ `
    <div style="height:500px; width:100%; vertical-align: top;">
        <zen-popover ...="${spreadArgs(args, argTypes)}">
            ...
            <zen-card style="display:inline-table; background: white;">
                ...
                <zen-space no-wrap="true" spacing="md" padding="lg">
                    ...
                    <!-- value -->
                    <zen-input style="width: 192px;"></zen-input>
                    <!-- add group filter -->
                    <zen-icon id="plus"></zen-icon>
                    <!-- remove filter -->
                    <zen-icon id="trash"></zen-icon>
                </zen-space>
                <zen-space no-wrap="true" spacing="md" padding="lg">
                    <!-- query row button -->
                    ...
                    <!-- value -->
                    <zen-input disabled="true"  style="width: 192px;"></zen-input>
                    <!-- add group filter -->
                    <zen-icon id="plus2"></zen-icon>
                    <!-- remove filter -->
                    <zen-icon id="trash2"></zen-icon>
                </zen-space>

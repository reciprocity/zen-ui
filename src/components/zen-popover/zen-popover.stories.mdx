...
<Meta title="Layout/Popover" component="zen-popover" argTypes={argTypes} />
...
export const StoryTriggerEvents = args => {
  return html/*html*/ `
    <sb-zen-space spacing="sm" no-wrap horizontal-align="space-evenly" vertical-align="start" data-test="outer-element">
      <sb-zen-button variant="primary">Click toggle</sb-zen-button>
      <sb-zen-popover padding="md">
        <sb-zen-text size="sm">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</sb-zen-text>
      </sb-zen-popover>
      <sb-zen-button variant="primary">Click outside</sb-zen-button>
      <sb-zen-popover padding="md" close-on-target-click="false">
        <sb-zen-text size="sm">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</sb-zen-text>
      </sb-zen-popover>
      <sb-zen-button variant="primary">Hover</sb-zen-button>

...
export const StoryPositionVariants = args => {
  return html/*html*/ `
    <sb-zen-space no-wrap p="2xl" spacing="sm" horizontal-align="center" vertical-align="center">
      <sb-zen-button variant="primary">left</sb-zen-button>
      <sb-zen-popover position="left" style="max-width: 120px">
        <sb-zen-space p="md">
          <sb-zen-text size="sm"
            >Lorem Ipsum is simply dummy text of the printing and typesetting industry.</sb-zen-text
          >
      ...
      <sb-zen-popover position="bottom-end" style="position:absolute; right:0;">
        <sb-zen-space p="md">
          <sb-zen-text size="sm"
            >Lorem Ipsum is simply dummy text of the printing and typesetting industry.</sb-zen-text
          >
      ...
      <sb-zen-popover position="top-start">
        <sb-zen-space p="md">
          <sb-zen-text size="sm"
            >Lorem Ipsum is simply dummy text of the printing and typesetting industry.</sb-zen-text
          >
      ...
      <sb-zen-popover position="top-end" style="position:absolute; right:0;">
        <sb-zen-space p="md">
          <sb-zen-text size="sm"
            >Lorem Ipsum is simply dummy text of the printing and typesetting industry.</sb-zen-text
          >
      ...
      <sb-zen-popover position="right" style="max-width: 120px">
        <sb-zen-space p="md">
          <sb-zen-text size="sm"
            >Lorem Ipsum is simply dummy text of the printing and typesetting industry.</sb-zen-text
          >
...
export const StoryTriggerEvents = args => {
  return html/*html*/ `
    <sb-zen-space spacing="sm" no-wrap horizontal-align="space-evenly" vertical-align="start">
      ...
      <sb-zen-popover close-on-target-click="false">
        <sb-zen-space p="md">
          <sb-zen-text size="sm"
            >Lorem Ipsum is simply dummy text of the printing and typesetting industry.</sb-zen-text
          >
  ...
  return html/*html*/ `
    <div style="height: 200px; overflow: auto;" data-test="scroll">
      <sb-zen-space no-wrap horizontal-align="center" vertical-align="center" style="height: 400px;">
        <sb-zen-button variant="primary"> Top Start </sb-zen-button>
        <sb-zen-popover position="bottom-end" visible="true" close-on-click-out="false">
          <sb-zen-space p="md">
            <sb-zen-text size="sm"
  ...
  return html/*html*/ `
    <sb-zen-space no-wrap spacing="lg" horizontal-align="start" vertical-align="top">
      ...
      <sb-zen-popover position="bottom-start" interactive="true" style="width: fit-content">
        <sb-zen-space vertical data-test="filter">
          <sb-zen-space horizontal-align="start" p="lg">
            <sb-zen-text size="xs" variant="heading">Filters</sb-zen-text>
          </sb-zen-space>
          <sb-zen-space no-wrap="true" spacing="md" p="lg">
            <!-- query row button -->
          ...
          <sb-zen-space horizontal-align="end" p="lg" style="width:100%;">

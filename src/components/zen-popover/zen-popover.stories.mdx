...
export const StoryPositionVariants = args => {
  return html/*html*/ `
    <sb-zen-space no-wrap padding="2xl" spacing="sm" horizontal-align="center" vertical-align="center">
      ...
      <sb-zen-popover show-arrow padding="md" position="left" style="max-width: 120px">
        <sb-zen-text size="sm">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</sb-zen-text>
      </sb-zen-popover>
      <sb-zen-button variant="blue-filled">bottom-start</sb-zen-button>
      <sb-zen-popover show-arrow padding="md" position="bottom-start" style="max-width: 300px">
        <sb-zen-text size="sm">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</sb-zen-text>
      </sb-zen-popover>
      ...
      <sb-zen-popover
        ...
        padding="md"
        position="bottom-end"
        style="position:absolute; right:0; max-width: 300px"
      >
        <sb-zen-text size="sm">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</sb-zen-text>
      </sb-zen-popover>
      <sb-zen-button variant="blue-filled">top-start</sb-zen-button>
      <sb-zen-popover show-arrow padding="md" position="top-start" style="max-width: 300px">
        <sb-zen-text size="sm">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</sb-zen-text>
      </sb-zen-popover>
      <sb-zen-button variant="blue-filled">top-end</sb-zen-button>
      <sb-zen-popover show-arrow padding="md" position="top-end" style="position:absolute; right:0; max-width: 300px">
        <sb-zen-text size="sm">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</sb-zen-text>
      </sb-zen-popover>
      <sb-zen-button variant="blue-filled">right</sb-zen-button>
      <sb-zen-popover show-arrow padding="md" position="right" style="max-width: 120px">
        <sb-zen-text size="sm">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</sb-zen-text>
      </sb-zen-popover>
    </sb-zen-space>
  `;

    ...
    <sb-zen-space vertical spacing="lg" horizontal-align="center">
      ...
      <sb-zen-card>
        <sb-zen-text>
          ...
          consectetur suscipit in sapien, proin eget etiam blandit elit sociis, euismod bibendum faucibus dolor
          himenaeos. Donec aliquet curabitur nam pellentesque felis ligula metus egestas, at volutpat urna vitae velit
          varius dolor bibendum dictumst, lacinia cubilia justo consequat sed consectetur laoreet.
        </sb-zen-text>
      </sb-zen-card>

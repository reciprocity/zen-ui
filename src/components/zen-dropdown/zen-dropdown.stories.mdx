    ...
    >
      ...
      <zen-option default-padding="false" value="2">
        <div class="content">
          ...
          <b>Item 2</b>
          <span style="margin-left: auto"><zen-icon id="icon1"></zen-icon></span>
        </div>
      </zen-option>
    ...
    <zen-dropdown id="dropdown-with-options-slot" class="mb-80" style="min-height: 3.2rem; max-width: 300px;">
      ...
      <zen-option default-padding="false" value="1">
        <div class="content">
          <img class="icon" src=${iconGreen} alt="icon" />
          <b>Item 1</b>
          <span style="margin-left: auto"><zen-icon id="icon2"></zen-icon></span>
        </div>
      </zen-option>
      <zen-option default-padding="false" value="2">
        <div class="content">
          ...
          <span style="margin-left: auto"><zen-icon id="icon3"></zen-icon></span>
        </div>
      </zen-option>
      ...
      <zen-option default-padding="false" value="3">
        <div class="content">
          ...
          <b>Item 3</b>
          <span style="margin-left: auto"><zen-icon id="icon4"></zen-icon></span>
        </div>
      </zen-option>
    </zen-dropdown>
  ...
  html/*html*/ `
    <zen-form-group>
      <zen-space vertical spacing="md">
        <zen-space vertical>
          <zen-text variant="label">Name</zen-text>
          <zen-input></zen-input>
        </zen-space>
        <zen-space vertical>
          <zen-text variant="label">Lastname</zen-text>
          <zen-input></zen-input>
        </zen-space>
        <zen-space vertical>
          <zen-text variant="label">Select country</zen-text>
          <zen-dropdown>
            <zen-option value="Argentina">Argentina</zen-option>
            <zen-option value="Slovenia">Slovenia</zen-option>
            <zen-option value="United States">United States</zen-option>
          </zen-dropdown>
        </zen-space>
        <zen-space vertical>
          <zen-textarea placeholder="Describe yourself"></zen-textarea>
        </zen-space>
        <zen-space vertical>
          <zen-button>Save</zen-button>
        </zen-space>
      </zen-space>
    </zen-form-group>
  `;

...
export const Template = args => {
  ...
  return html/*html*/ `
    ...
    <sb-zen-dropdown id="dropdown-controls" style="min-width: 20rem" ...="${spread(camelKeysToKebab(args))}">
...
export const CustomIcons = args => {
  ...
  return html/*html*/ `
    <sb-zen-dropdown id="dropdown-with-options-slot" style="min-height: 3.2rem; min-width: 20rem">
...
export const StoryFormGroup = () =>
  html/*html*/ `
    <sb-zen-space vertical spacing="md" padding="sm" horizontal-align="stretch" style="min-width: 20rem">
      <sb-zen-space vertical>
        <sb-zen-text variant="label">Name</sb-zen-text>
        <sb-zen-input style="width: 100%"></sb-zen-input>
      </sb-zen-space>
      <sb-zen-space vertical padding="sm" spacing="sm">

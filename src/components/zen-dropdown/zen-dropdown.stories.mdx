...
export const CustomIcons = args => {
  ...
  return html/*html*/ `
    ...
    <sb-zen-dropdown id="dropdown-with-options-slot" class="mb-80" style="min-height: 3.2rem; max-width: 300px;">
...
export const InvitePeople = () => {
  ...
  return html/*html*/ `<sb-zen-input id="input1" placeholder="Username" class="mb-72" style="max-width: 500px">
    <sb-zen-dropdown
      id="dropdown1"
      slot="trailingSlot"
      borderless="true"

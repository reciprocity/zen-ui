...
export const Template = args => {
  ...
  return html/*html*/ `
    ...
    <sb-zen-dropdown id="dropdown-controls" style="max-width: 300px;" ...="${spread(camelKeysToKebab(args))}">
      <div class="separator">Some custom title</div>
      <sb-zen-option value="1">Item 1</sb-zen-option>
      <sb-zen-option default-padding="false" value="2">
        <div class="content">
      ...
      <sb-zen-option value="4">Item 4</sb-zen-option>
...
export const CustomIcons = args => {
  ...
  return html/*html*/ `
    <sb-zen-dropdown id="dropdown-with-options-slot" style="min-height: 3.2rem; max-width: 300px;">
      <div class="separator">Group 1</div>
      <sb-zen-option default-padding="false" value="1">
        <div class="content">
          <img class="icon" src=${iconGreen} alt="icon" />
          <b>Item 1</b>
      ...
      <sb-zen-option default-padding="false" value="3">
        <div class="content">
...
export const InvitePeople = () => {
  ...
  return html/*html*/ `<sb-zen-input id="input1" placeholder="Username" style="max-width: 500px">
    <sb-zen-dropdown
      id="dropdown1"
      slot="trailingSlot"
      borderless="true"
  ...
  html/*html*/ `
    <sb-zen-form-group>
      <sb-zen-space vertical spacing="md">
        ...
        <sb-zen-space vertical>
          <sb-zen-text variant="label">Lastname</sb-zen-text>
          <sb-zen-input></sb-zen-input>
        </sb-zen-space>
        <sb-zen-space vertical>
        ...
        <sb-zen-space vertical>
          <sb-zen-textarea placeholder="Describe yourself"></sb-zen-textarea>
        </sb-zen-space>
        <sb-zen-space vertical>

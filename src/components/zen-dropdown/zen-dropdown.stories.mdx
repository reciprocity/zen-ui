...
export const CustomIcons = args => {
  ...
  return html/*html*/ `
    <sb-zen-dropdown id="dropdown-with-options-slot" style="min-height: 3.2rem; width: 20rem">
...
export const InvitePeople = () => {
  ...
  return html/*html*/ `<sb-zen-input id="input1" placeholder="Username" style="width: 20rem">
    <sb-zen-dropdown
      id="dropdown1"
      slot="trailingSlot"
      borderless="true"
...
export const StoryFormGroup = () =>
  html/*html*/ `
    <sb-zen-space vertical spacing="md" padding="sm" horizontal-align="stretch" style="width: 20rem">

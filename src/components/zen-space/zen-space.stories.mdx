    ...
    <div class="row">
      ${values.map(
        align => html/*html*/ `
          <div class="story">
            <p>${align}</p>
            <sb-zen-space vertical-align="${align}" horizontal-align="center" padding="xs">
              <div class="item">Item</div>
    ...
    <div class="row">
      ${values.map(
        align => html/*html*/ `
          <div class="story">
            <p>${align}</p>
            <sb-zen-space horizontal-align="${align}" padding="xs">
              <div class="item">Item</div>
              <div class="item tall slim">Item</div>
              <div class="item short">Item</div>
              <div class="item tall">Item</div>
      ...
      ${values.map(
        align => html/*html*/ `
          <div class="story tall">
            ...
            <sb-zen-space vertical vertical-align="${align}" horizontal-align="center" padding="xs">
              <div class="item">Item</div>
    ...
    <div class="row">
      ${values.map(
        align => html/*html*/ `
          <div class="story tall">
            <p>${align}</p>
            <sb-zen-space vertical horizontal-align="${align}" padding="xs">
              <div class="item">Item</div>
              <div class="item tall slim">Tall</div>
              <div class="item short">Short</div>
              <div class="item tall">Giant</div>
    ...
    <div class="row">
      ${values.map(
        padding => html/*html*/ `
          <div class="story">
            <p>"${padding}"</p>
            <sb-zen-space padding="${padding}" horizontal-align="stretch" vertical-align="stretch">

...
export const StoryRowAlign = () => {
  const aligns1 = ['start', 'end', 'center', 'baseline', 'stretch'];
  const aligns2 = ['start', 'end', 'center', 'baseline', 'stretch', 'space-between', 'space-around', 'space-evenly'];
  return html/*html*/ `
    <div class="row">
      <div class="col">
        <p>vertical-align</p>
...
export const StoryColumnAlign = () => {
  const aligns1 = ['start', 'end', 'center', 'baseline', 'stretch', 'space-between', 'space-around', 'space-evenly'];
  const aligns2 = ['start', 'end', 'center', 'baseline', 'stretch'];
  return html/*html*/ `
    <p>vertical-align</p>
    <div class="row">
      ${aligns1.map(
        align => html/*html*/ `
          <div class="col tall">
            <p class="info two-rows"><b>${align}</b></p>
...
<Canvas>
  <Story name="aligns">{StoryRowAlign.bind({})}</Story>
</Canvas>
...
<Canvas>
  <Story name="alignsColumn">{StoryColumnAlign.bind({})}</Story>
</Canvas>

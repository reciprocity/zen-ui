...
export const StoryDefault = args => {
  ...
  return html/*html*/ ` <sb-zen-icon id="zen-icon-element" ...="${spreadArgs(args, argTypes)}"></sb-zen-icon> `;
};

export const StoryIconPadding = args => {
  ['#zen-icon-xs', '#zen-icon-sm', '#zen-icon-md', "#zen-icon-lg", "#zen-icon-xl"].forEach(id => {
  ...
  return html/*html*/ `
    ...
    <sb-zen-space  horizontal-align="space-evenly">

...
export const StoryWithControls = args => {
  ...
  return html/*html*/ `
    ...
    <zen-modal id="modal1" @cancelClicked="${e => {e.target.show = false}}" ...="${spreadArgs(args)}">
...
export const StoryMultipleModals = () => {
  ...
  return html/*html*/ `
    ...
    <zen-modal id="editor" label="Risk score editor" @cancelClicked="${closeEditor}">
    ...
    <zen-modal id="confirm" label="Confirmation" @cancelClicked="${e => {e.target.show = false}}">
      <p>Are you sure?!</p>
